...
- **Upstream `dsh-theme-tarkov` reference pinned at `be1123c1c158e58ba0aa1c311c22d793b09f9c0d`** (v0.2.0), MIT, inspected directly. **No code and no media were taken from it**; it is a read-only reference for the visual language and the feature set. `THIRD_PARTY_NOTICES.md` records the boundary, including the precise list of assets that upstream ships and this project does not (361 Scav voice clips, an Altyn helmet PNG, three game sound effects).
